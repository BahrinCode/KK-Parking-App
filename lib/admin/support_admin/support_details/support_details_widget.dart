...
class SupportDetailsWidget extends StatefulWidget {
  ...
  static String routeName = 'support_details';
  static String routePath = '/supportDetails';
            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          if (columnSupportReqRow?.photo !=
                                                  null &&
                                              columnSupportReqRow?.photo != '')
                                            Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 0.0),
                                  child: FutureBuilder<List<EnforcementRow>>(
                                    future: EnforcementTable().querySingleRow(
                                      queryFn: (q) => q,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      List<EnforcementRow>
                                          userContentEnforcementRowList =
                                          snapshot.data!;

                                      final userContentEnforcementRow =
                                          userContentEnforcementRowList
                                                  .isNotEmpty
                                              ? userContentEnforcementRowList
                                                  .first
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (rowUserRow?.userId ==
                                                          userContentEnforcementRow
                                                              ?.userId)
                                                        Padding(
                                                          padding:
                                                              EdgeInsetsDirectional
                  ...
                  if (columnSupportReqRow?.status != 'Closed')
                    Align(
                      alignment: AlignmentDirectional(0.0, 1.0),
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
