...
import 'user_transaction_copy_model.dart';
export 'user_transaction_copy_model.dart';

class UserTransactionCopyWidget extends StatefulWidget {
  const UserTransactionCopyWidget({super.key});

  static String routeName = 'user_transactionCopy';
  static String routePath = '/userTransactionCopy';

  @override
  State<UserTransactionCopyWidget> createState() =>
      _UserTransactionCopyWidgetState();
}

class _UserTransactionCopyWidgetState extends State<UserTransactionCopyWidget>
    with TickerProviderStateMixin {
  late UserTransactionCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTransactionCopyModel());
