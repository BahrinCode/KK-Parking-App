      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case MessageSupportRow:
            return MessageSupportRow(data);
          case VehicleRow:
            return VehicleRow(data);
          case EnforcementRow:
            return EnforcementRow(data);
          case WalletRow:
            return WalletRow(data);
          case CarColorRow:
            return CarColorRow(data);
          case NotificationRow:
            return NotificationRow(data);
          case PermitRow:
            return PermitRow(data);
          case SupportReqRow:
            return SupportReqRow(data);
          case TransactionRow:
          ...
          case CarRow:
            return CarRow(data);
          case CompoundRow:
            return CompoundRow(data);
          case CarTypeRow:
            return CarTypeRow(data);
          case ParkingLocationRow:
            return ParkingLocationRow(data);
          case SeasonalPassRow:
            return SeasonalPassRow(data);
          case OffenceRow:
            return OffenceRow(data);
          case UserRow:
            return UserRow(data);
          case CouponcodeRow:
