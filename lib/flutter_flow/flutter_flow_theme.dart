...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1E3C5E);
  late Color secondary = const Color(0xFF235789);
  late Color tertiary = const Color(0xFF90ABC3);
  late Color alternate = const Color(0xFFC7D5E0);
  late Color primaryText = const Color(0xFFFDFFFC);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF235789);
  late Color secondaryBackground = const Color(0xFF1E3C5E);
  ...
  late Color babyPowder = Color(0xFFFDFFFC);
  late Color columbiaBlue = Color(0xFFC7D5E0);
  late Color powderBlue = Color(0xFF90ABC3);
  late Color lapisLazuli = Color(0xFF235789);
  late Color yaleBlue = Color(0xFF1E3C5E);
  late Color lightBlue = Color(0xFF39BF06);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF235789);
  late Color tertiary = const Color(0xFF90ABC3);
  late Color alternate = const Color(0xFFFDFFFC);
  late Color primaryText = const Color(0xFFC7D5E0);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF235789);
  late Color secondaryBackground = const Color(0xFF1E3C5E);
  late Color accent1 = const Color(0x4C19DB8A);
