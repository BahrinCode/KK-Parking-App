...
import 'homeadas_model.dart';
export 'homeadas_model.dart';

class HomeadasWidget extends StatefulWidget {
  const HomeadasWidget({super.key});

  static String routeName = 'homeadas';
  static String routePath = '/homeadas';

  @override
  State<HomeadasWidget> createState() => _HomeadasWidgetState();
}

class _HomeadasWidgetState extends State<HomeadasWidget>
    with TickerProviderStateMixin {
  late HomeadasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeadasModel());
