...
class _UserInfoWidgetState extends State<UserInfoWidget> {
  ...
  void initState() {
    ...
    _model.unameTextController ??= TextEditingController();
    ...
    _model.uaddressTextController ??= TextEditingController();
    _model.uaddressFocusNode ??= FocusNode();
                                ...
                                children: [
                                    ...
                                    child: Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://images.unsplash.com/photo-1579783902188-1dbf2b672dc8?w=500&h=500',
                                            width: 120.0,
                                            height: 120.0,
                                            fit: BoxFit.cover,
                                          ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model.unameTextController,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.uemailTextController,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.uPhoneTextController,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.uaddressTextController,
                                        focusNode: _model.uaddressFocusNode,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Address',
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .uaddressTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await UserTable().insert({
                            'username': _model.unameTextController.text,
                            'fname': _model.fnameTextController.text,
                            'phone': _model.uPhoneTextController.text,
                            'address': _model.uaddressTextController.text,
                            'email': _model.uemailTextController.text,
                            'user_id': currentUserUid,
                            'profileImage': _model.uploadedFileUrl,
                          });
                          await WalletTable().insert({
                            'balance': 0.0,
                            'user_id': currentUserUid,
                          });
