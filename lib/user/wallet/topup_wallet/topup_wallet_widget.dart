...
import 'topup_wallet_model.dart';
export 'topup_wallet_model.dart';

class TopupWalletWidget extends StatefulWidget {
  const TopupWalletWidget({super.key});

  static String routeName = 'topup_wallet';
  static String routePath = '/topupWallet';
...
class _TopupWalletWidgetState extends State<TopupWalletWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupWalletModel());

    _model.topupamountTextController ??= TextEditingController();
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model.topupamountTextController,
                                  focusNode: _model.topupamountFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      ...
                                      .asValidator(context),
                                  inputFormatters: [_model.topupamountMask],
                                ),
                              ].divide(SizedBox(height: 16.0)),
                            ),
                          ),
                                      ...
                                      onTap: () async {
                                        ...
                                        _model.apiPayment =
                                            await FlutterFlowStripeApiFlowAPIGroup
                                                ...
                                                .call(
                                          amount: _model
                                              .topupamountTextController.text,
                                          currency: 'MYR',
                                          description: 'Wallet',
                                        ...
                                        if ((_model.apiPayment?.succeeded ??
                                          ...
                                          if (_model.paymentStatus == true) {
                                            ...
                                            context.pushNamed(
                                              PaymentConfirmedWidget.routeName,
                                              queryParameters: {
