...
class AuthUserWidget extends StatefulWidget {
  const AuthUserWidget({super.key});

  static String routeName = 'AuthUser';
...
class _AuthUserWidgetState extends State<AuthUserWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthUserModel());
